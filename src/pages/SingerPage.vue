  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-input v-model="select_word" size="mini" placeholder="搜索歌手" class="handle-input"></el-input>
    ...
    <el-table size="mini" border style="width: 100%" height="480px" :data="data" @selection-change="hanldeSelectChange">
